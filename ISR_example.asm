...
CurrentTime:  ds 5 ; Formerly BCD counter, keeps track of the current time.
AlarmTime:    ds 5 ; ~86000 seconds in a day is 5 bytes? keeps track of the time the alarm will go off.
